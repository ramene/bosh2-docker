...
RUN apt-get update -y && \
    apt-get install -y wget ruby ruby-dev openssl python python-setuptools python-dev build-essential zlibc zlib1g-dev libxslt-dev libxml2-dev libssl-dev libreadline6 libreadline6-dev libyaml-dev libsqlite3-dev sqlite3 git && \
